class ShopToggleService
  ...
  def index
    ...
    shop_associations.as_json(include: { linked_toggle: { include: :link_generator } })
  end
  ...
  def create
    ...
    toggle_params[:toggle_type] = 'Shop'
  ...
  def destroy
    ...
    { message: 'Shop Toggle soft deleted successfully' }
  end
